...
/*         const ss =this.state;
        ...
        axios.post( "api/auth/login", { ss }).then((resp) => {
        }) */
    }
    render() {
        return (
                        ...
                        <form>
                            <div className="contentlogin">
                                <div className="inputtext">
                                    ...
                                    <input name="login" placeholder="Enter login" value={this.state.login} onChange={this.handleInputChange} required/>
                                </div>
                                <div className="inputtext">
                                    ...
                                    <input name="password" placeholder="Enter password" value={this.state.password} onChange={this.handleInputChange} required type="password"/>
                                </div>
                            </div>
                        </form>
